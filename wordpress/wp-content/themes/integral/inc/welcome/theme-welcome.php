...
class Integral_Welcome {
		...
		?>
			<div class="notice theme-notice">
				...
				<div class="theme-notice-cta">
					<a href="<?php echo esc_url( admin_url( 'themes.php?page=integral-welcome#getting_started' ) ); ?>" class="button button-hero" style="text-decoration: none;"><?php _e( 'Setup Integral', 'integral' ); ?> <?php echo $dismiss_url ?></a>
	...
	public function integral_welcome_screen() {
		...
		<div class="wrap about-wrap theme-welcome">
            ...
            <h1><?php esc_html_e('Welcome to Integral', 'integral'); ?> <span><?php esc_html_e('VERSION 1.4.3.1', 'integral'); ?></span></h1>
